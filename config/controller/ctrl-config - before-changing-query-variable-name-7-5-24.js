...
//  username = req.body.username
  ...
  if (typeof req.body.roles !== 'undefined') {
    ...
    query = "update ["+dbName+"].[ECCAnalytics].[Users]  set [roles] = '"+req.body.roles+"'where userid = '"+userid+"'";
  ...
  if (typeof req.body.pswd !== 'undefined') {
    ...
    query = "update ["+dbName+"].[ECCAnalytics].[Users]  set [pswd] = '"+req.body.pswd+"' where userid = '"+userid+"'";
  ...
  if (typeof req.body.pswd !== 'undefined' && typeof req.body.roles !== 'undefined') {
   ...
   query = "update ["+dbName+"].[ECCAnalytics].[Users]  set [pswd] = '"+req.body.pswd+"', [roles] = '"+req.body.roles+"' where userid = '"+userid+"'";
